...
@SuppressWarnings("resource") @FacesRenderer(componentFamily = Famlies.OUTPUT_COMPONENT_FAMILY, rendererType = PanelRenderer.RENDERER_TYPE) public class PanelRenderer extends RendererBase {
